...
export default function NavBar() {
  ...
  return (
    <nav
      className={`p-5 h-18 md:flex md:items-center md:justify-between fixed w-full endless-river ${
        open ? "shadow-none" : "shadow-2xl"
      }`}
    >
      ...
      <ul
        className={`md:flex md:items-center md:opacity-100 md:static
              ...
              transition-all ease-in duration-500 mt-[-8px] endless-river shadow-2xl
